        ...
        <div className="row projects">
          <div className="twelve columns collapsed">
            ...
            <div id="portfolio-wrapper" className="bgrid-quarters s-bgrid-thirds cf">
                  ...
                  <div className="art-description">
                    <div className="text-wrapper">
                      ...
                      <p>
                        ...
                        the top level of the English football league system.My
                        Task was to build the UI part of header and footer,
                        table and manager page of website and implementation
                        of functionality. Collaborative project, accomplished
                        along with 3 team members in 5 days.
                      </p>
                    </div>
                    <ul className="actions">
                      <div className="actions-wrapper">
              ...
              <div className="article-wrapper">
                <article className="col-12 col-12-xsmall work-item">
                  <a href="https://github.com/Harshsanas/Rentomojo.git" className="image fit thumb" target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="art-description">
                    <div className="text-wrapper">
                      ...
                      <p>
                        A web application that provides a platform to rent out
                        the finest quality daily need products at nominal
                        price. My Task was to build the landing page, and
                        Modal part and Login/Signup functionalities.
                        Collaborative project, accomplished along with 3 team
                        members in 10 days.
                      </p>
                    </div>
                    <ul className="actions">
